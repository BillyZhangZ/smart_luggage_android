...
public class DeviceControlActivity extends Activity {
    ...
    public static String GET_SIM_CMD = "AT+GTSIM\r";
    public static String GET_WEIGHT_CMD = "AT+GTWT\r";
    public static String GET_BATT_CMD = "AT+GTBAT\r";
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
            	...
            	sendData(GET_SIM_CMD);
            }
            else if (BluetoothLeService.ACTION_DATA_AVAILABLE.equals(action)) {
                displayData(intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
            	//sendData(GET_WEIGHT_CMD);
                Toast.makeText(getApplicationContext(), "绑定成功",
                Toast.LENGTH_LONG).show();
                
                Intent intentBack = new Intent(DEVICE_BONDED);   
                intentBack.setClass(DeviceControlActivity.this, LuggageActivity.class);  
                intentBack.setFlags(intentBack.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            new ExpandableListView.OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                       ...
                       // 	mWriteCharacteristic.setValue("AT+GTSIM\r");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "绑定中..",
